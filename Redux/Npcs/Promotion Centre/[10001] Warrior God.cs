                    ...
                    switch (client.ProfessionLevel)
                    {
                        ...
                        case 1://level 40
                            ...
                            else
                            {
                                if (client.Level >= 40)
                                {
                                    AddText("It seems that you have forgot to set your stats after a reborn has been done. your Strength needs to be 80, Agility needs to have a minimum of 25, Vitality as a minimum of 20");
                        ...
                        case 2://level 70
                            ...
                            else
                            {
                                if (client.Level >= 70)
                                {
                                    AddText("It seems that you have forgot to set your stats after a reborn has been done. your Strength needs to be 140, Agility needs to have a minimum of 45, Vitality as a minimum of 32");
                                    AddOption("How foolish of me, I'll set my stats first.", 255);
                                    break;
                                }
                                else
                        ...
                        case 3://level 100
                            ...
                            else
                            {
                                if (client.Level >= 100)
                                {
                                    AddText("It seems that you have forgot to set your stats after a reborn has been done. your Strength needs to be 205, Agility needs to have a minimum of 60, Vitality as a minimum of 42");
                                    AddOption("How foolish of me, I'll set my stats first.", 255);
                                    break;
                                }
                                else
                        ...
                        case 4://level 110
                            ...
                            else
                            {
                                if (client.Level >= 110)
                                {
                                    AddText("It seems that you have forgot to set your stats after a reborn has been done. your Strength needs to be 225, Agility needs to have a minimum of 65, Vitality as a minimum of 47");
                                    AddOption("How foolish of me, I'll set my stats first.", 255);
                                    break;
                                }
                                else
