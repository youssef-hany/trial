                    ...
                    switch (client.ProfessionLevel)
                    {
                        ...
                        case 1://level 40
                            ...
                            else
                            {
                                if (client.Level >= 40)
                                {
                                    AddText("It seems that you have forgot to set your stats after a reborn has been done. your Agility needs to be 25, Vitality needs to have a minimum of 22, Spirit as a minimum of 80");
                        ...
                        case 2://level 70
                            ...
                            else
                            {
                                if (client.Level >= 70)
                                {
                                    AddText("It seems that you have forgot to set your stats after a reborn has been done. your Agility needs to be 45, Vitality needs to have a minimum of 32, Spirit as a minimum of 140");
                                    AddOption("How foolish of me, I'll set my stats first.", 255);
                                    break;
                                }
                                else
                        ...
                        case 3://level 100
                            ...
                            else
                            {
                                if (client.Level >= 100)
                                {
                                    AddText("It seems that you have forgot to set your stats after a reborn has been done. your Agility needs to be 60, Vitality needs to have a minimum of 42, Spirit as a minimum of 205");
                                    AddOption("How foolish of me, I'll set my stats first.", 255);
                                    break;
                                }
                                else
                        ...
                        case 4://level 110
                            ...
                            else
                            {
                                if (client.Level >= 110)
                                {
                                    AddText("It seems that you have forgot to set your stats after a reborn has been done. your Agility needs to be 65, Agility needs to have a minimum of 47, Vitality as a minimum of 225");
                                    AddOption("How foolish of me, I'll set my stats first.", 255);
                                    break;
                                }
                                else
