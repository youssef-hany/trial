                    ...
                    switch (client.ProfessionLevel)
                    {
                        ...
                        case 1://level 40
                            ...
                            else
                            {
                                if (client.Level >= 40)
                                {
                                    AddText("It seems that you have forgot to set your stats after a reborn has been done. your Strength needs to be 25, Agility needs to have a minimum of 90, Vitality as a minimum of 12");
                        ...
                        case 2://level 70
                            ...
                            else
                            {
                                if (client.Level >= 70)
                                {
                                    AddText("It seems that you have forgot to set your stats after a reborn has been done. your Strength needs to be 45, Agility needs to have a minimum of 150, Vitality as a minimum of 22");
                                    AddOption("How foolish of me, I'll set my stats first.", 255);
                                    break;
                                }
                                else
                        ...
                        case 3://level 100
                            ...
                            else
                            {
                                if (client.Level >= 100)
                                {
                                    AddText("It seems that you have forgot to set your stats after a reborn has been done. your Strength needs to be 60, Agility needs to have a minimum of 215, Vitality as a minimum of 32");
                                    AddOption("How foolish of me, I'll set my stats first.", 255);
                                    break;
                                }
                                else
                        ...
                        case 4://level 110
                            ...
                            else
                            {
                                if (client.Level >= 110)
                                {
                                    AddText("It seems that you have forgot to set your stats after a reborn has been done. your Strength needs to be 68, Agility needs to have a minimum of 235, Vitality as a minimum of 34");
                                    AddOption("How foolish of me, I'll set my stats first.", 255);
                                    break;
                                }
                                else
