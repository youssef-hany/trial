...
namespace Redux.Managers
{
    public static class DropManager
    {
        ...
        public static double CHANCE_REFINED = 10.0;
        public static double CHANCE_UNIQUE = 5.0;
        public static double CHANCE_ELITE = 1.0;
        public static double CHANCE_SUPER = 0.2;
        public static double CHANCE_PLUS = .5;
        public static double CHANCE_METEOR = 0.072;
        public static double CHANCE_DRAGONBALL = 0.00556;
        ...
        public static uint GenerateDropID(byte _level)
        {
            ...
            var quality = Common.Random.Next(5);

            if (Common.PercentSuccess(CHANCE_SUPER))
                quality = QUALITY_SUPER;
            else if (Common.PercentSuccess(CHANCE_ELITE))
                quality = QUALITY_ELITE;
            else if (Common.PercentSuccess(CHANCE_UNIQUE))
                quality = QUALITY_UNIQUE;
            else if (Common.PercentSuccess(CHANCE_REFINED))
