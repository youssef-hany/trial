...
namespace Redux.Database.Domain
{
    public class DbCharacter
    {
        ...
        public virtual byte PreviousLevel { get; set; }
        ...
        public virtual DateTime VipExpire { get; set; }
        public virtual DateTime LuckyTimeExpires { get; set; }
        ...
        public virtual uint SecondQuest { get; set; }
    }
}
